...
class HonorariosFactureros(db.Model):
    ...
    sellos = db.Column(db.Float, default = 0)
    seguro = db.Column(db.Float, default = 0)
    nro_comprobante = db.Column(db.String(8))
    tipo = db.Column(db.String(1), default = "H")
    importe_bruto = db.Column(db.Float, default = 0)
    iibb = db.Column(db.Float, default = 0)
    libramiento_pago = db.Column(db.Float, default = 0)
    otras_retenciones = db.Column(db.Float, default = 0)
